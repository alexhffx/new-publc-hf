---
title: "FX Uncertainty: Why Financial Planning & Treasury Must Work Hand-in-Hand"
slug: "fx-uncertainty-why-financial-planning-treasury-must-work-hand-in-hand"
description: "FP&A and treasury teams must work in tandem. Collaborative action is the only way businesses can build resilience amid today’s ongoing market turbulence."
date: "2025-04-08"
...
#### Understanding FX Uncertainty and Its Dual Impact 
...
-   **Earnings Predictability** (FP&A’s responsibility): FX fluctuations can directly influence revenues and margins, destabilising operational budgets and forecasts. 
-   **Liquidity & Solvency** (Treasury’s responsibility): Sudden or severe fluctuations threaten cash flow stability and financial health. 

###### Distinct Roles:

-   **FP&A:** Focuses on crafting likely scenarios to support accurate budgeting and operational forecasting and often gets FX budget rates from the Treasury. 
-   **Treasury:** Develops strategies to mitigate severe risks through hedging and liquidity management and ensures that budget FX rates can be achieved regardless of the macro environment.
...
#### FP&A's Role: Forecasting Likely Outcomes 
...
-   **Revenues & Margins:** Evaluating and forecasting the transactional and economic exposure of currency fluctuations on income streams. 
-   **Earnings Volatility:** Anticipating risks associated with translation exposure and ensuring accurate financial reporting. 
...
-   **Baseline Scenarios** (neutral, predictable market conditions) 
-   **Moderate Stress Scenarios** (potential but manageable currency shifts) 

By focusing on agility, accuracy, and responsiveness, FP&A establishes a strong foundation for decision-making.

#### Treasury’s Role: Preparing for the Worst 
...
-   **Budget rates:** Establishing and protecting FX rate forecasts that used by FP&A and other teams and realistic and achievable given prevailing market conditions.
-   **Tail risk modelling:** Identifying and quantifying the risks to potential macroeconomic and other shocks.
-   **Hedging Policies:** Instrument options such as forwards, options, and natural hedges ensure stability. 
-   **Liquidity Buffers:** Adequate cash reserves for unexpected shortfalls. 
-   **Counterparty Risk Assessments:** Evaluating the reliability of FX specialist firms and banking relationships. 

Treasury ensures that even under catastrophic scenarios, the organisation’s liquidity and solvency remain strong.

#### A bit of theory - the probability angle
...
#### Connecting the Two: A Holistic Approach 
...
###### How FP&A Supports Treasury:

-   Identifies currencies and expected cashflows in. 
-   Provides actionable data that helps Treasury craft targeted hedging strategies.

###### How Treasury Enhances FP&A:

-   Delivers hedging insights that stabilise forecasting efforts. 
-   Provides FX budget rate forecasts and a more predictable financial baseline that FP&A can use to build reliable financial outlooks. 
...
-   **Joint Planning Sessions:** Collaborate on scenario planning to evaluate the full picture of FX risks.
-   **Regular Exposure Reviews:** Frequently review and analyse currency exposures as a team. 
-   **Integrated Dashboards:** Implement tools that deliver combined visibility into forecasts and hedging activity. 
-   **Unified Narrative:** Present a cohesive story to leadership and stakeholders, ensuring alignment across key functions.
...
#### Common Pitfalls of Isolated Approaches 

When FP&A and Treasury operate independently, the risks grow exponentially, including:

-   **Underestimating tail risks:** Less experienced teams often underestimate the magnitude of potential FX moves during crisis time and are slow to react when the events unfold, hoping that everything normalises soon.
-   **Forecasting Gaps:** Misaligned assumptions lead to inaccuracies that affect the business strategy. 
-   **Inefficient Hedging:** Either under-hedging (leaving the company exposed) or over-hedging (creating unnecessary costs). 
-   **Strategic Disconnects:** Lack of communication creates vulnerabilities, impacting earnings, liquidity, and operational stability.

The cost of isolation far outweighs the investment in collaboration.

#### Checklist: Integrating FP&A and Treasury 

Aligning FP&A and Treasury doesn’t have to be daunting. Use this framework to get started:

-   **Schedule Regular Risk Assessments:** Establish joint meetings to review FX exposure scenarios. 
-   **Define Clear Roles:** Clarify responsibilities to prevent overlap or gaps. 
-   **Adopt Integrated Tools:** Use dashboards or software such as HedgeFlows that collates forecasts, exposures, and hedging data. 
-   **Share Metrics:** Agree on success metrics to track alignment and progress effectively. 
...
-   Build resilience by addressing both predictable and extreme FX scenarios. 
-   Combine insights and actions, leading to stronger financial outcomes. 
-   Provide leadership with a unified narrative, empowering better decision-making.
...
_Looking for more insights? Reach out to our sales team for the tools and expertise needed to transform your FX operations and planning._
