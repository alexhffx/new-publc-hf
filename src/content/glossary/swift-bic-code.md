...
term: "SWIFT Code (BIC)"
slug: "swift-bic-code"
definition: "SWIFT code, or Bank Identifier Code (BIC), is one of the most pertinent parts of the SWIFT transfer instructions you need to make your international wire transfer right."
category: "payments-operations"
relatedTerms:
  - "swift-transfer"
  - "telegraphic-transfer"
  - "cross-border-payments"
seoDescription: "Check your SWIFT code aka Bank Identifier Code (BIC) - one of the most pertinent parts of the SWIFT instructions to get right for an international transfer"
lastUpdated: "2024-04-28"
---

SWIFT code, or Bank Identifier Code (BIC), is one of the most pertinent parts of the SWIFT transfer instructions you need to make your international [wire transfer](/glossary/swift-transfer) right. 
...
Where possible, use tools such as Confirmation of Payee or [International Bank Account Validation](https://www.hedgeflows.com/international-bank-account-verification) tools to avoid human errors and Authorised push payment fraud. Modern payment automation systems such as HedgeFlows can help perform these checks seamlessly as an integral part of your payment processes.
